...
public class HoverButtonTreeManager : MonoBehaviour
{
    ...
    [SerializeField] private Button turnLeftForward;
    [SerializeField] private Button turnLeftBackward;

    [Header("Third Layer Buttons - Right Path")] [SerializeField]
    private Button turnRight;

    [SerializeField] private Button turnRightForward;
    [SerializeField] private Button turnRightBackward;
    ...
    private void InitializeButtonLists()
    {
        ...
        // Left path
        thirdLayerButtons.Add(turnLeft);
        thirdLayerButtons.Add(turnLeftForward);
        thirdLayerButtons.Add(turnLeftBackward);

        // Right path
        thirdLayerButtons.Add(turnRight);
        thirdLayerButtons.Add(turnRightForward);
        thirdLayerButtons.Add(turnRightBackward);
    ...
    private void SetupValidConnections()
    {
        ...
        validConnections[leftButton] = new List<Button> { turnLeft, turnLeftForward, turnLeftBackward };
        validConnections[rightButton] = new List<Button> { turnRight, turnRightForward, turnRightBackward };
    ...
    private void SetupButtonActions()
    {
        ...
        // Left path actions
        buttonActions[turnLeft] = () => movement.ShouldTurnLeft();
        buttonActions[turnLeftForward] = () => movement.ShouldMoveForwardLeft();
        buttonActions[turnLeftBackward] = () => movement.ShouldMoveBackwardLeft();

        // Right path actions
        buttonActions[turnRight] = () => movement.ShouldTurnRight();
        buttonActions[turnRightForward] = () => movement.ShouldMoveForwardRight();
        buttonActions[turnRightBackward] = () => movement.ShouldMoveBackwardRight();
